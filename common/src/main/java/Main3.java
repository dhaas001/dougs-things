...
import com.common.Dog;
import com.common.Lion;
import com.common.Zoo;
...
//            // create a JAXBContext capable of handling classes generated into
            ...
            JAXBContext jc = JAXBContext.newInstance(new Class[] {Zoo.class,Dog.class,Lion.class}, 
                jaxbProperties);
            Marshaller marshaller = jc.createMarshaller();
     
            Zoo zoo = new Zoo();
            zoo.onExhibit.add(new Dog());
            zoo.onExhibit.add(new Lion());
            zoo.resting.add(new Dog());
            zoo.resting.add(new Lion());
